...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "hero-mesh":
          "radial-gradient(circle at top left, rgba(45, 212, 191, 0.15), transparent 40%), radial-gradient(circle at top right, rgba(251, 113, 133, 0.15), transparent 40%), linear-gradient(135deg, rgba(3, 7, 18, 0.9), rgba(15, 23, 42, 0.9))"
      },
      keyframes: {
        float: {
